function inputs() {
    ...
    document.getElementById("result1").innerHTML = ticketsDeflected.toLocaleString();
...
function seeChart4() {
    ...
    const SAVINGS_GENERATED_BY_QUARK = {
        'Saving From Deflection': inputsFinished[2],
        'Saving From Increased Productivity': inputsFinished[3],
        'Total Saving from Using Both Modules': inputsFinished[4]
    };
